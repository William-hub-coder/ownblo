    ...
    <div className="py-20 px-4 animate-pulse">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex justify-center gap-2 mb-12">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="h-9 w-20 bg-[var(--cyber-border)] rounded-full" />
          ))}
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            ...
            >
              <div className="h-48 bg-[var(--cyber-border)]" />
              <div className="p-5 space-y-3">
                <div className="h-6 w-3/4 bg-[var(--cyber-border)] rounded" />
                <div className="h-4 w-full bg-[var(--cyber-border)] rounded" />
                <div className="h-4 w-2/3 bg-[var(--cyber-border)] rounded" />
                <div className="flex gap-1.5 mt-3">
                  <div className="h-6 w-16 bg-[var(--cyber-border)] rounded-full" />
                  <div className="h-6 w-20 bg-[var(--cyber-border)] rounded-full" />
                  <div className="h-6 w-14 bg-[var(--cyber-border)] rounded-full" />
                </div>
              </div>
            </div>
          ))}
